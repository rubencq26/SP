...
fmin = 50; fmax = 150; cmin = 100; cmax = 300
IO(fmin:fmax,cmin:cmax) = 255
close all
imshow(IO)
...
IO(fmin:fmax,cmin:cmax,1:2) = 0;
IO(fmin:fmax,cmin:cmax,3)= 255;
...
% Poner rectangulo azul en imagen intensidad
Imod1 = I;
Imod2 = I;
Imod3 = I;

[N,M] = size(I);
Imod = uint8(zeros(N,M,3));

Imod1(100:150,200:400) = 0;
Imod2(100:150,200:400) = 0;
Imod3(100:150,200:400) = 255;
Imod(:,:,1) = Imod1;
Imod(:,:,2) = Imod2;
Imod(:,:,3) = Imod3;
