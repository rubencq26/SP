...
b = [2 2], whos b; b = cat(2,2,2)  % el primer 2 indica trabajar por columnas (disponer en columnas)
b = [2; 2], whos b; b = cat(1,2,2) % el primer 1 indica trabajar por filas (disponer en filas)
b = [2, 2]
...
D{1,2} = round(2*rand(5*numDatos,1));
datos = categorical();
...
figure
figure('Name', 'Esta es la Figura Numero 3')
figure(6), set(6, 'Name', 'Esta es la figura 6')
...
% CREAR FUNCION QUE SUME TRES ELEMENTOS EN UINT8
% COMPROBAR SU FUNCIONAMIENTO. GUARDA LA FUNCION EN UN DIRECTORIO LLAMADO funciones, y
...
% Ejercicio4:
% a) Generar una matriz A, 10x10, de números enteros aleatorios entre 0 y 
A = round(10*rand(10,10)) 
